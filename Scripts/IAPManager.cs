...
public class IAPManager : MonoBehaviour, IStoreListener
{
    ...
    void AddCoin(int _index)
    {
        switch (_index)
        {
            ...
            case 0:
                //FindObjectOfType<Menu>().Purchase(0);
                //GameManager.Instance.MoreCoin(240);
                GM.GetInstance().AddDiamond(0, true);
                break;
            case 1:
                //FindObjectOfType<Menu>().Purchase(1);
                // GameManager.Instance.MoreCoin(750);
                GM.GetInstance().AddDiamond(3000, true);
                break;
            case 2:
                //FindObjectOfType<Menu>().Purchase(2);
                // GameManager.Instance.MoreCoin(1350);
                GM.GetInstance().AddDiamond(1400, true);
                break;
            case 3:
                //FindObjectOfType<Menu>().Purchase(2);
                // GameManager.Instance.MoreCoin(2700);
                GM.GetInstance().AddDiamond(800, true);
                break;
            case 4:
                //FindObjectOfType<Menu>().Purchase(2);
                //  GameManager.Instance.MoreCoin(7000);
